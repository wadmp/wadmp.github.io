## WebAccess/DMP version 2.4.0: December 11 2021
...
* When saving device configuration, and the error occurs, now the real error message from the server is shown instead of a general error message.
