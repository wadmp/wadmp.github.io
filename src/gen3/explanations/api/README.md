...
* Download [latest repository](https://bitbucket.org/bbsmartworx/dmp-public/get/00b7e5bd78a6.zip).
...
* Example Command (*from the* \python_scripts\csv_utilities\ *folder*): 
